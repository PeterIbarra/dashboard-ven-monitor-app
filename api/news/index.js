...
// ── VENEZUELAN RSS FEEDS — local media for ICG actor coverage ──
const VEN_RSS_FEEDS = [
  // Oficialistas — SSL/Cloudflare may block some; pipeline tolerates failures
...
// ── RSS SOURCES for news aggregator ──
const RSS_SOURCES = [
  ...
  { name:"Caracas Chronicles", feed:"https://www.caracaschronicles.com/feed/", type:"news", lang:"en" },
