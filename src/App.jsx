...
// ═══════════════════════════════════════════════════════════════
// DATA IMPORTS — Update these files for weekly SITREP updates
// ═══════════════════════════════════════════════════════════════
import { SCENARIOS } from './data/scenarios.js';
import { WEEKS, MONITOR_WEEKS, KPIS_LATEST, TENSIONS } from './data/weeks.js';
import { INDICATORS, SCENARIO_SIGNALS } from './data/indicators.js';
import { AMNISTIA_TRACKER } from './data/amnistia.js';
import { CURATED_NEWS, CURATED_FACTCHECK, GDELT_ANNOTATIONS } from './data/news.js';
import { CONF_HISTORICO, VEN_PRODUCTION_MANUAL, CONF_MESES, CONF_DERECHOS, CONF_SERVICIOS, CONF_ESTADOS, VZ_MAP } from './data/conflictividad.js';
import { POLYMARKET_SLUGS } from './data/polymarket.js';
