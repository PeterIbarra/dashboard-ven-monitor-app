...
// ═══════════════════════════════════════════════════════════════
// IMPORTS — Data, constants, utilities, components
// ═══════════════════════════════════════════════════════════════
import {
  SCENARIOS, WEEKS, KPIS_LATEST, TENSIONS,
  MONITOR_WEEKS, INDICATORS, SCENARIO_SIGNALS,
  GDELT_ANNOTATIONS, POLYMARKET_SLUGS,
  CONF_HISTORICO, CONF_MESES, CONF_DERECHOS, CONF_SERVICIOS, CONF_ESTADOS,
  VZ_MAP, WEEK_DRIVERS, TABS,
} from "./data";

import {
  BG, BG2, BG3, BORDER, TEXT, MUTED, ACCENT,
  SC, SEM, font, fontSans,
} from "./constants";

import { useIsMobile } from "./hooks/useIsMobile";
import { fetchAllGdelt, generateMockGdelt, IS_DEPLOYED, CORS_PROXIES } from "./gdelt";
