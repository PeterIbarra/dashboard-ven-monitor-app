...
const indicators = [
  { label:"Fallecidos", value:"6.301", detail:"Balance oficial · 10 ago", color:"#dc2626" },
  { label:"Viviendas evaluadas", value:"53.314", detail:"corte de reconstrucción", color:"#ca8a04" },
  { label:"Escombros retirados", value:"23,26%", detail:"del total estimado", color:"#f97316" },
...
const extendedIndicators = [
  ...
  { label:"Viviendas entregadas", value:"287", detail:"Cobertura aún limitada" },
...
export function EarthquakeIndicatorsWidget({ onOpen }) {
  ...
  return <Card accent="#dc2626" style={{ marginBottom:0, padding:0, overflow:"hidden" }}>
    <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", gap:10, flexWrap:"wrap", padding:"10px 14px", borderBottom:`1px solid ${BORDER}` }}>
      <div><div style={{ fontSize:10, fontFamily:font, color:"#dc2626", letterSpacing:".12em", textTransform:"uppercase", fontWeight:700 }}>Indicadores del Terremoto</div><div style={{ fontSize:9, color:MUTED, marginTop:2 }}>Doble sismo del 24 de junio · corte semanal 07–14 de agosto de 2026</div></div>
    ...
    <div style={{ padding:"8px 14px", borderTop:`1px solid ${BORDER}`, background:"#fff7ed", display:"flex", justifyContent:"space-between", gap:10, flexWrap:"wrap" }}>
      ...
      <span style={{ fontSize:8, color:MUTED, fontFamily:font }}>Fuente: Gobierno encargado · corte semanal 07–14 ago 2026</span>
    </div>
  </Card>;
}
