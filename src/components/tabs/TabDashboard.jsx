  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
      ...
      {(() => {
        ...
        // Shared with App.jsx (writes this same number back to Supabase for the
        // Daily Brief email) via src/lib/instabilityIndex.js — see that file for
        // the full formula, single source of truth so both stay in sync.
