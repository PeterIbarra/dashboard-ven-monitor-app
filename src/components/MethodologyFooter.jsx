        ...
        <div style={{ maxWidth:800, margin:"0 auto" }}>
          ...
          <div style={sectionStyle}>
            ...
            {section==="idx" && <div style={bodyStyle}>
              Es un número de <b>0 a 100</b> que resume "qué tan inestable está la situación" combinando 25 factores diferentes. Funciona como un termómetro:<br/><br/>
              ...
              • Si crece el <b>número de estados con un evento eléctrico confirmado</b> (evidencia directa IODA, no solo racionamiento inferido), el índice sube — es un factor aparte de la severidad promedio: un apagón severo pero muy localizado y uno más leve pero extendido a varios estados no deberían pesar igual.<br/>
              • Si la probabilidad de <b>E1 (transición pacífica)</b> es alta, el índice baja — porque es un factor estabilizador.<br/><br/>
              <b>6 de los 25 factores se actualizan solos</b> en tiempo real (brecha cambiaria, petróleo, índice bilateral, conectividad IODA, cortes eléctricos IODA, estados con corte detectado). Los demás se actualizan con cada informe semanal.
            </div>}
          </div>
