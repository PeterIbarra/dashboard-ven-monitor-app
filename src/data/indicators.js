...
export const INDICATORS = [
  ...
  { dim:"Energético", icon:"⚡", esc:"E3", name:"Exportaciones de crudo", desc:"Volumen semanal bajo licencias OFAC",
    ...
    hist:[
      ...
      ["green","up","~740 kbd"],
      ["green","up","~770 kbd"],
      ["green","up","~800 kbd ↑60.6%"],
      ["green","up","~800 kbd · VLCC"],
      ["green","up","788 kbd · récord 7 años"],
      ["green","up","1.021 kbd (+10,5%)"],
      ["green","up","Export. EE.UU. duplicadas"],
      ["green","up","Repsol x3 meta 2029 · Petropymi-Alep"],
      ["green","up",">1,09M bpd marzo · máx. 6 meses"],
      ["green","up","1,09M bpd marzo · récord 6 meses · Q1 -14,2% acum."],
  ...
  { dim:"Energético", icon:"⚡", esc:"E3", name:"Ventas petroleras (ingresos)", desc:"Acuerdos bajo GL49 y GL50/50A",
    ...
    hist:[
      ["yellow","flat","En negociación"],
      ["yellow","up","Acuerdos Vitol/Trafigura"],
      ["green","up","Proy. USD 3-4B"],
      ["green","up","Contratos activos"],
      ["green","up","India + EE.UU."],
      ["green","up","Proy. USD 6.000M"],
      ["green","up","Proy. USD 6.000M"],
      ["green","up","+USD 24-120M/mes · crudo +10%"],
      ["green","up","Merey $52,31 (+$9,10)"],
      ["yellow","down","Ingresos PDVSA −46% 1er bim."],
      ["green","up","FII Priority · Signum · incentivos fiscales"],
      ["green","up","USD 2.398M causados · Brent 102 · Merey 73,3"],
      ["green","up","USD 2.398M causados · máx. dic 2018 · BCV evalúa sanciones"],
  ...
  { dim:"Energético", icon:"⚡", esc:"E3", name:"Licencias OFAC activas", desc:"GL49, GL50, GL50A — cobertura operativa",
    ...
    hist:[
      ["green","flat","GL49 activa"],
      ["green","flat","GL49 + GL50"],
      ["green","flat","Sin cambios"],
      ["green","flat","Sin cambios"],
      ["green","flat","GL50/50A vigentes"],
      ["green","flat","FAQ 1238 Cuba"],
      ["green","flat","GL49+GL50/50A+FAQ1238"],
      ["green","up","GL129A Rosneft · Monómeros 2028"],
      ["green","up","GL49+50/50A+GL51"],
      ["green","up","GL46B+48A+49A+51+52"],
      ["green","up","GL-53 + OFAC minero (oro, minerales)"],
      ["green","up","Sanciones DR levantadas · Citgo en disputa"],
      ["green","up","EE.UU. evalúa levantar sanciones BCV · Citgo defensa conjunta"],
  ...
  { dim:"Energético", icon:"⚡", esc:"E3", name:"Producción Chevron / Majors", desc:"Operaciones de empresas occidentales en bloques venezolanos",
    ...
    hist:[
      ["yellow","flat","Operación básica"],
      ["yellow","up","Autorización ampliada"],
      ["green","up","Incremento confirmado"],
      ["green","up","Ampliación activa"],
      ["yellow","flat","Revisión 19 contratos"],
      ["yellow","up","Expansión anunciada"],
      ["yellow","up","Expansión anunciada"],
      ["green","up","Exxon equipo · Shell acuerdos"],
      ["green","up","Chevron+Shell+Repsol"],
      ["green","up","Repsol +50%/+200% · Maurel&Prom"],
      ["yellow","flat","ConocoPhillips: «inadecuadas» · Chevron pide"],
      ["yellow","flat","Shell negocia Loran ~20 Tcf · GNL vía Trinidad"],
      ["green","up","COP+XOM evalúan retorno · Shell Loran 1er gas 2027 · 93 taladros"],
  ...
  { dim:"Energético", icon:"⚡", esc:"E2", name:"Infraestructura de refinación", desc:"Capacidad operativa refinerías nacionales",
    ...
    hist:[
      ["red","flat","<20% capacidad"],
      ["red","flat","Sin mejora"],
      ["red","flat","Mantenimiento pendiente"],
      ["red","flat","Exportación compensa"],
      ["red","flat","Crítica pero estable"],
      ["yellow","up","~35% capacidad (Reuters)"],
      ["yellow","flat","~35% capacidad"],
      ["yellow","flat","~35% capacidad"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos",["red","down","31% capacidad (399K bpd) · caída desde 35% feb · fallas eléctricas"]],
      ["red","down","31% capacidad · caída desde 35% feb · fallas eléctricas"],
  ...
  { dim:"Energético", icon:"⚡", esc:"E2", name:"Taladros activos", desc:"Operaciones de perforación nuevas",
    ...
    hist:[
      ["red","flat","Bajo histórico"],
      ["red","flat","Sin variación"],
      ["red","flat","Sin variación"],
      ["red","flat","Sin variación"],
      ["red","flat","Sin variación"],
      ["red","flat","2-4 activos (Monaldi)"],
      ["red","flat","2-4 activos"],
      ["red","flat","2-4 activos"],
      ["green","up","Tendencia al alza"],
      ["green","up","Maurel & Prom Maracaibo (1º 8a)"],
      ["green","flat","Tendencia al alza · Repsol/Maurel"],
      ["green","flat","Tendencia al alza · Repsol/Maurel activos"],
      ["green","flat","93 activos · meta 1,37M bpd dic 2026 (Min. Henao)"],
  ...
  { dim:"Energético", icon:"⚡", esc:"E3", name:"Recaudación fiscal", desc:"SENIAT y flujo tributario asociado al repunte energético",
    ...
    hist:[
      ["green","up","+78% SENIAT feb. vs enero"],
      ["green","up","SENIAT +78% acum."],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos"],
      ["green","up","SENIAT Q1 USD 3.512M (+26,6%) · ISLR +95,5%",["yellow","flat","Sin datos nuevos · SENIAT Q1 base referencia"]],
      ["yellow","flat","Sin datos nuevos S13"],
      ["yellow","flat","Sin datos nuevos S14 · BCV publica balanza pagos 2025: superávit cta corriente USD 3.336M"],
  ...
  { dim:"Energético", icon:"⚡", esc:"E3", name:"Apertura sector minero", desc:"Reformas y licencias para inversión extranjera en minería",
    ...
    hist:[
      ["green","up","Gold Reserve · reforma legislativa"],
      ["green","up","GL-51 · Dec.5266 · Ley Minas"],
      ["yellow","flat","Ley Minas diferida art.12"],
      ["green","up","OFAC licencias mineras · Ley Minas 55/130"],
      ["green","flat","OFAC minero vigente · Ley Minas diferida"],
      ["green","up","Ley de Minas aprobada unánimemente por AN"],
      ["green","up","Ley Orgánica de Minas promulgada · apertura inversión privada y extranjera · Rodríguez agradece a Trump"],
  ...
  { dim:"Energético", icon:"⚡", esc:"E3", name:"Diversificación gas natural", desc:"Desarrollo de gas como producto estratégico de exportación",
    ...
    hist:[
      ["green","up","Cardón IV firmado · GLP a Colombia"],
      ["green","flat","Shell-Monagas gas interno · Cardón IV"],
      ["green","up","Shell negocia Loran ~20 Tcf · gas GNL vía T&T"],
      ["green","up","Shell Loran 1er gas mid-2027 · AVPG +134% en 10 años · Proyecto Dragon"],
      ["green","up","Shell asume campo Loran-Manatee · 7,3 TCF en lado venezolano · primer gas mid-2027"],
  ...
  { dim:"Político", icon:"🏛", esc:"E3", name:"Ley de Amnistía", desc:"Operativización y verificación independiente",
    ...
    hist:[
      ["yellow","flat","Anunciada"],
      ["yellow","up","Aprobada AN"],
      ["yellow","up","Primeras excarcelaciones"],
      ["green","up","Comisión operativa"],
      ["green","up","1.200+ beneficiados"],
      ["green","up","Promulgada 19 feb"],
      ["green","up","4.203 sol. · 3.231 plenas"],
      ["green","up","9.060 sol. · 5.628 plenas"],
      ["green","up","7.727 beneficiados"],
      ["green","up","7.580 benef. · 24% rechazados"],
      ["green","up","8.146 libertades · 11.559 sol. · prórroga 30d"],
      ["green","flat","Sin datos nuevos esta semana"],
      ["green","flat","Sin datos nuevos S13 · prórroga 30d activa"],
  ...
  { dim:"Político", icon:"🏛", esc:"E3", name:"Excarcelaciones verificadas", desc:"Foro Penal: presos políticos activos",
    ...
    hist:[
      ["yellow","flat","0 verificadas"],
      ["yellow","up","12 verificadas"],
      ["yellow","up","45 verificadas"],
      ["yellow","up","78 verificadas"],
      ["yellow","up","108 verificadas"],
      ["yellow","flat","383 verif. · 895 oficial"],
      ["yellow","up","568 activos (FP)"],
      ["yellow","up","568 presos · 245 liberados"],
      ["yellow","flat","670 verif. / 508 presos"],
      ["yellow","up","690 verif. / 515 presos"],
      ["yellow","flat","690 verif. / 515 presos / 179 militares"],
      ["yellow","flat","Sin datos nuevos · 515 presos"],
      ["yellow","flat","Sin datos nuevos · 515 presos políticos"],
  ...
  { dim:"Político", icon:"🏛", esc:"E4", name:"Cautelares vigentes", desc:"Personas bajo medidas restrictivas no resueltas",
    ...
    hist:[
      ["red","flat",">11.000 personas"],
      ["red","flat",">11.000 + 87 nuevas ONU"],
      ["red","flat","Sin datos nuevos"],
      ["red","flat","Sin datos nuevos"],
      ["red","flat","Sin datos nuevos"],
      ["red","flat","Sin datos nuevos · >11.000 vigentes"],
      ["red","flat","Sin datos nuevos · >11.000 cautelares vigentes"],
  ...
  { dim:"Político", icon:"🏛", esc:"E4", name:"Cohesión FANB", desc:"Señales de fractura o lealtad institucional",
    ...
    hist:[
      ["yellow","flat","Sin señales fractura"],
      ["yellow","flat","Sin señales fractura"],
      ["yellow","flat","Ajustes menores"],
      ["yellow","down","Presión cooperación EE.UU."],
      ["yellow","down","Cubanos retirándose"],
      ["yellow","down","Padrino 12 años · malestar"],
      ["yellow","flat","Sin señales nuevas"],
      ["yellow","flat","Sin señales nuevas"],
      ["yellow","flat","SOUTHCOM patrulla 6/03"],
      ["green","up","Nueva cúpula: Prieto Martínez"],
      ["green","flat","González López giro institucional FANB"],
      ["yellow","down","FANB retoma «Chávez vive» con González López"],
      ["yellow","flat","Sin señales nuevas · González López mantiene giro institucional"],
  ...
  { dim:"Político", icon:"🏛", esc:"E3", name:"Reorganización del Ejecutivo", desc:"Capacidad de gestión institucional",
    ...
    hist:[
      ["yellow","flat","Maduro removido"],
      ["yellow","up","Delcy consolida"],
      ["green","up","Gabinete activo"],
      ["green","up","Estructura operativa"],
      ["green","up","Cancillería reestructurada"],
      ["green","up","Poder Ciudadano: encargados"],
      ["green","up","Poder Ciudadano: 30 días"],
      ["green","up","Relaciones diplomáticas plenas"],
      ["green","up","Min. Hidrocarburos Henao"],
      ["green","up","42% gabinete modif. · 11 cambios"],
      ["green","up","Procuradora Seijo · designaciones inst."],
      ["green","up","Remoción Gavidia · Coronado · Constituyente Laboral",["green","up","Devoe (Fiscal) + González Lobato (Defensora) · Poder Ciudadano completo"]],
      ["green","up","Devoe Fiscal + González Lobato Defensora · Poder Ciudadano completo"],
  ...
  { dim:"Político", icon:"🏛", esc:"E1", name:"Agenda electoral", desc:"Calendario y compromisos electorales concretos",
    ...
    hist:[
      ["red","flat","Sin agenda"],
      ["red","flat","Sin agenda"],
      ["yellow","flat","Señales vagas"],
      ["yellow","up","Rubio: legitimación req."],
      ["yellow","up","Presión EE.UU. activa"],
      ["yellow","up","2/3 exige elecciones"],
      ["yellow","up","Rubio reitera exigencia"],
      ["yellow","up","66% exige · H.R. 7674"],
      ["red","down","Washington: 2027"],
      ["red","flat","Sin fecha · horizonte 2027"],
      ["yellow","up","180 días Congreso → plan Rubio"],
      ["yellow","up","90 días cumplidos · debate interinato · movimientos CNE"],
      ["yellow","flat","CNE rechaza propuesta academia · Nicmer Evans: Q4-2026/Q1-2027"],
  ...
  { dim:"Político", icon:"🏛", esc:"E4", name:"Marcos restrictivos vigentes", desc:"Leyes de odio, terrorismo, delitos de expresión",
    ...
    hist:[
      ["red","flat","Ley Odio vigente"],
      ["red","flat","Sin cambio"],
      ["red","flat","Sin cambio"],
      ["red","flat","Sin cambio"],
      ["red","flat","Sin cambio"],
      ["red","flat","Sin cambio"],
      ["red","flat","Stalin exige derogar"],
      ["yellow","up","J.Rodríguez: revisión Ley Odio"],
      ["red","flat","Sin cambios"],
      ["red","flat","Sin cambios"],
      ["red","down","Registro portales (Urbaneja) · Ley Odio"],
      ["red","flat","Sin cambios"],
      ["red","flat","Sin cambios"],
  ...
  { dim:"Político", icon:"🏛", esc:"E1", name:"Liderazgo opositor", desc:"Índice de liderazgo y capacidad de articulación opositora",
    ...
    hist:[
      ["green","up","MCM 106,84/137 · Guanipa 102"],
      ["yellow","down","MCM marginalizada"],
      ["yellow","flat","MCM en CERAWeek · sin retorno"],
      ["green","up","MCM 123,68 · Guanipa 119,80 · CERAWeek"],
      ["green","up","Machado-Rubio Dept. Estado · reactivación comanditos"],
      ["green","up","PUD hoja de ruta 12-abr · MCM retorno 'decisión definitiva' · Madrid 18-abr"],
      ["green","up","MCM en Elíseo con Macron (13-abr) · PM Países Bajos La Haya (15-abr) · retorno inminente anunciado"],
  ...
  { dim:"Económico", icon:"📊", esc:"E2", name:"Brecha cambiaria", desc:"Diferencial BCV vs. mercado paralelo",
    ...
    hist:[
      ...
      ["yellow","down","~46%"],
      ["yellow","down","~46%"],
      ["yellow","down","52,6% · 631 vs 414"],
      ["yellow","flat",">50% · persistente"],
      ["red","up","BCV 414 / Par 622"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos"],
      ["green","up","Convergencia USDT-banca ~10% · BCV 570,75"],
      ["yellow","flat","~30% USDT vs oficial · BCV USD 133M intervención semanal"],
  ...
  { dim:"Económico", icon:"📊", esc:"E2", name:"Inflación", desc:"Tasa mensual proyectada",
    ...
    hist:[
      ["yellow","flat","~12% mensual"],
      ["yellow","flat","~10% mensual"],
      ["yellow","up","~8% mensual"],
      ["yellow","up","Desacelerando"],
      ["yellow","up","~6% proyectado"],
      ["yellow","up","174% proy. anual (UCAB)"],
      ["yellow","flat","FMI: tres dígitos anual"],
      ["yellow","flat","174% proy. 2026"],
      ["red","up","617% anualizada (BCV)"],
      ["yellow","down","197% proy. 2026 · 144% 2027"],
      ["red","flat",">600% interanual · 51,9% acum. ene-feb"],
      ["red","flat",">600% interanual"],
      ["red","flat","13,1% mensual · 649,5% anual (BCV) · Macroconsultores 636-656%"],
  ...
  { dim:"Económico", icon:"📊", esc:"E2", name:"Ingresos de la población", desc:"Salario mínimo y poder adquisitivo real",
    ...
    hist:[
      ...
      ["red","flat","Sin ajuste"],
      ["red","flat","Sin ajuste"],
      ["red","flat","47 meses sin ajuste"],
      ["red","flat","69,5% < USD 300"],
      ["red","flat","Canasta 550 vs 270"],
      ["red","flat","USD 256 vs canasta 550"],
      ["red","flat","70% <USD 300"],
      ["yellow","up","Bono 150 USD · 300M Fondo"],
      ["red","down","97 protestas · brecha salarial persistente"],
      ["red","flat","Salario <1 USD · 4 años congelado · marcha 9 abril"],
      ["red","flat","Salario <1 USD congelado 4 años · aumento 1° mayo sin monto"],
  ...
  { dim:"Económico", icon:"📊", esc:"E2", name:"Sistema eléctrico", desc:"Disponibilidad y frecuencia de cortes",
    ...
    hist:[
      ["red","flat","Cortes frecuentes"],
      ["red","flat","Sin mejora"],
      ["red","flat","Sin mejora"],
      ["red","flat","Sin mejora"],
      ["red","flat","Crítico"],
      ["red","flat","14,8h sin suministro"],
      ["red","flat","Crítico · sin inversión"],
      ["red","flat","14,8h sin suministro"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos"],
      ["red","down","Siemens/GE evalúan · Táchira 8,70% · CAF"],
      ["yellow","up","CAF reactiva plan 7 años · renovables + térmicas"],
      ["yellow","flat","Sin datos nuevos · fallas eléctricas refinación PDVSA"],
  ...
  { dim:"Económico", icon:"📊", esc:"E3", name:"Percepción dirección del país", desc:"Encuestas de opinión pública",
    ...
    hist:[
      ["yellow","flat","~35% positivo"],
      ["yellow","up","~40% positivo"],
      ["yellow","up","~44% positivo"],
      ["green","up","~48% positivo"],
      ["green","up","~50% positivo"],
      ["green","up","75% dirección correcta"],
      ["green","flat","51,5% mejor s/ Maduro"],
      ["green","flat",">50% dirección correcta"],
      ["yellow","flat","Reconocimiento EE.UU."],
      ["yellow","flat","71% salida «a cualquier costo»"],
      ["green","flat","58% país más democrático (AtlasIntel)"],
      ["green","flat","Rubio: estabilización «lograda en gran medida»"],
      ["yellow","down","Aprobación Rodríguez 34,6% · 92,3% rechaza liderazgo (Meganálisis)"],
  ...
  { dim:"Económico", icon:"📊", esc:"E3", name:"PIB trimestral", desc:"Crecimiento económico confirmado",
    ...
    hist:[
      ["green","up","+7,07% Q4 2025"],
      ["green","flat","Proy. 2 dígitos 2026"],
      ["green","flat","+6,9% proy. 2026"],
      ["green","flat","19 trim. consecutivos crecimiento"],
      ["green","flat","SENIAT Q1 +26,6% real",["red","flat","PIB 2025 = 35,7% del nivel 2012 · Q1 exportaciones -14,2%"]],
      ["red","flat","PIB 2025 = 35,7% nivel 2012 · Q1 export -14,2%"],
      ["red","flat","BCV publica balanza pagos 2025: superávit cta corriente USD 3.336M (+42% vs 2024) · bonos 48 ctvs"],
  ...
  { dim:"Internacional", icon:"🌐", esc:"E3", name:"Cooperación EE.UU.–Venezuela", desc:"Nivel operativo de acuerdos bilaterales",
    ...
    hist:[
      ["yellow","up","Negociaciones iniciales"],
      ["yellow","up","Petróleo fluye"],
      ["green","up","SOUTHCOM reunión"],
      ["green","up","Visitas técnicas"],
      ["green","up","Plan 3 fases"],
      ["green","up","Chris Wright visita"],
      ["green","up","Trump \"nuevo amigo\""],
      ["green","up","Relaciones restablecidas"],
      ["green","up","Reconocimiento formal"],
      ["green","up","Bandera · Senado · nivel 3 · LG-52"],
      ["green","up","Misión diplom. · LG-53 · «pres. electa» · SOUTHCOM"],
      ["green","up","Sanciones DR levantadas · embajada · «empresa conjunta»"],
      ["green","up","FMI consulta miembros · BCV sanciones evaluadas · Citgo defensa conjunta"],
  ...
  { dim:"Internacional", icon:"🌐", esc:"E3", name:"Sanciones UE", desc:"Estado de sanciones europeas",
    ...
    hist:[
      ["red","flat","Sanciones plenas"],
      ["red","flat","Sin cambio"],
      ["red","flat","Sin cambio"],
      ["yellow","up","Señales apertura"],
      ["yellow","up","Diálogo España"],
      ["yellow","up","España propone levantar"],
      ["yellow","up","España propone levantar"],
      ["yellow","up","España: solicitud ante UE"],
      ["yellow","flat","Sin cambios"],
      ["yellow","flat","Sin cambios"],
      ["yellow","flat","Sin cambios"],
      ["yellow","flat","Sin cambios"],
      ["yellow","flat","Sin cambios"],
  ...
  { dim:"Internacional", icon:"🌐", esc:"E3", name:"China y Rusia", desc:"Balanza estratégica en contexto acercamiento EE.UU.",
    ...
    hist:[
      ["green","flat","Alineación plena"],
      ["green","flat","Sin cambio"],
      ["green","down","Señales tensión"],
      ["yellow","down","Rebalanceo activo"],
      ["yellow","down","Reducción presencia rusa"],
      ["yellow","down","Cuba retira asesores"],
      ["yellow","down","Cuba retira asesores"],
      ["yellow","flat","China: cooperación bilateral"],
      ["yellow","flat","GL-51 excluye Rusia"],
      ["yellow","flat","LG-52 excluye Rusia/Irán/China"],
      ["yellow","down","Buque ruso desvía a VEN · complejidad"],
      ["yellow","down","Embajador iraní con colectivos · tensión normalización"],
      ["yellow","down","Embajador iraní colectivos 23-Enero: antisemitismo · tensión geopolítica"],
  ...
  { dim:"Internacional", icon:"🌐", esc:"E1", name:"FMI y reinserción financiera", desc:"Diálogo con IFIs y acceso a mercados",
    ...
    hist:[
      ["red","flat","Fragmentación total"],
      ["red","flat","Sin diálogo"],
      ["red","flat","Sin diálogo"],
      ["yellow","up","Señales apertura"],
      ["yellow","up","Reuniones técnicas"],
      ["yellow","up","FMI: Intensa Fragilidad"],
      ["yellow","up","FMI: Intensa Fragilidad"],
      ["yellow","up","FMI: disposición si solicita"],
      ["yellow","flat","Sin avances nuevos"],
      ["yellow","flat","Sin avances nuevos"],
      ["yellow","flat","Sin avances nuevos"],
      ["yellow","flat","Sin avances nuevos"],
      ["green","up","FMI consulta formal miembros · bonos 2027 cerca 48 ctvs/USD"],
  ...
  { dim:"Internacional", icon:"🌐", esc:"E3", name:"Normalización diplomática", desc:"Reapertura embajadas y relaciones bilaterales",
    ...
    hist:[
      ["yellow","flat","Limitada"],
      ["yellow","up","Señales apertura"],
      ["green","up","Múltiples contactos"],
      ["green","up","Visitas ministros"],
      ["green","up","Cancillería reestructurada"],
      ["green","up","Tajani · Qatar"],
      ["green","up","Petro-Delcy 14 mar"],
      ["green","up","Burgum visita · Nahuel Gallo"],
      ["green","up","Reconocimiento formal"],
      ["green","up","Bandera EE.UU. · Senado · Nivel 3"],
      ["green","up","Misión Washington · sedes · «pres. electa»"],
      ["green","up","Embajada reabierta · SOUTHCOM «hito» · vuelos 10+ aerolíneas"],
      ["green","up","10 aerolíneas retoman vuelos · sistema digital visas EE.UU."],
  ...
  { dim:"Internacional", icon:"🌐", esc:"E1", name:"Presión legislativa EE.UU.", desc:"Proyectos de ley y condicionalidades del Congreso",
    ...
    hist:[
      ["yellow","up","H.R. 7674 · transición 180 días"],
      ["yellow","flat","H.R. 7674 vigente"],
      ["yellow","flat","Delegación Senado en Caracas"],
      ["yellow","up","180 días plan transición (resolución bipartidista)"],
      ["yellow","up","Loomer pide elecciones · presión cronograma"],
      ["yellow","flat","Sin cambios nuevos"],
      ["yellow","up","Kozak fija condiciones Fase 2: CNE + KPMG + retorno MCM · Wright: elecciones no son prioridad inmediata"],
  ...
  { dim:"Internacional", icon:"🌐", esc:"E3", name:"Relación Venezuela-Colombia", desc:"Agenda bilateral y cooperación fronteriza",
    ...
    hist:[
      ["green","up","Petro: «exitosa» · Mercosur · GLP"],
      ["green","flat","Petro: elecciones «no libres» · apoya DR"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Venezuela descarta vender Monómeros · sin señales nuevas en relación bilateral Venezuela-Colombia"],
  ...
  { dim:"Internacional", icon:"🌐", esc:"E3", name:"Proceso judicial Maduro", desc:"Caso narco en Distrito Sur de Nueva York",
    ...
    hist:[
      ["yellow","up","Rechazo desestimación · cargos adicionales"],
      ["yellow","flat","Sin datos nuevos",["yellow","flat","Juez Hellerstein rechaza compartir evidencia con prófugos"]],
      ["yellow","flat","Juez rechaza compartir evidencia con prófugos"],
      ["yellow","flat","Juez Hellerstein rechaza compartir material probatorio con coacusados prófugos · caso activo"],
  ...
  { dim:"Social", icon:"✊", esc:"E4", name:"Conflictividad laboral", desc:"Protestas semanales — eje salarial y gremial",
    ...
    hist:[
      ["yellow","flat","28 protestas · post-operativo"],
      ["green","down","22 protestas · baja intensidad"],
      ["green","down","18 protestas · mínimo ciclo"],
      ["yellow","up","25 protestas · amnistía diferida"],
      ["yellow","up","30 protestas · 11 estados"],
      ["yellow","up","35 protestas · 12 estados"],
      ["yellow","flat","32 protestas · brecha cambiaria"],
      ["yellow","up","38 protestas · presión salarial"],
      ["red","up","65 protestas · RÉCORD 12 mar"],
      ["yellow","down","46 protestas · bono contiene"],
      ["red","up","97 protestas 4 días · ESCALAMIENTO"],
      ["yellow","down","11 protestas 4 días · 9 estados · marcha 9 abr"],
      ["red","up","72 protestas 4 días (6-9 abr) · escala histórica · gas pimienta PNB"],
  ...
  { dim:"Social", icon:"✊", esc:"E4", name:"Cobertura territorial protestas", desc:"Estados con movilizaciones activas",
    ...
    hist:[
      ["yellow","flat","8 estados"],
      ["green","down","6 estados"],
      ["green","flat","7 estados"],
      ["yellow","up","9 estados"],
      ["yellow","up","11 estados"],
      ["yellow","up","12 estados"],
      ["yellow","down","10 estados"],
      ["yellow","up","14 estados"],
      ["red","up","23 estados · nacional"],
      ["yellow","down","14 estados"],
      ["red","up","22+ estados · nacional"],
      ["yellow","down","9 estados",["red","up","15 estados 9-abr · mayor dispersión del período (escalada 3→15)"]],
      ["red","up","15 estados 9-abr · escala 3→15 · mayor dispersión período"],
  ...
  { dim:"Social", icon:"✊", esc:"E4", name:"Conectividad y electricidad", desc:"Apagones e impacto en conectividad regional",
    ...
    hist:[
      ["yellow","flat","Sin datos nuevos"],
      ["red","down","Táchira 8,70% · Barinas 33,51% · Zulia 51,83%"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos IODA · crisis sanitaria: fiebre amarilla + malaria 25.000 casos 2026"],
  ...
  { dim:"Social", icon:"✊", esc:"E3", name:"Percepción pública", desc:"Encuestas de aprobación y dirección del país",
    ...
    hist:[
      ["yellow","flat","AtlasIntel 34,6% vs Hinterlaces 73% · 58% más democ."],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","down","Solo 9,3% reporta mejoras concretas (AtlasIntel) · 79% situación económica mala"],
      ["yellow","down","83,8% rechaza elogios Trump · 81% indicadores en rojo a 100 días · epidemia fiebre amarilla"],
  ...
  { dim:"Económico", icon:"📊", esc:"E3", name:"Atracción de inversión", desc:"Señales de FDI y apertura a capital internacional",
    ...
    hist:[
      ["green","up","FII Priority · Signum · CERAWeek · Petropymi-Alep"],
      ["green","up","OFAC sanciones DR · Shell Loran · vuelos · delegaciones",["green","up","FMI consulta · COP+XOM evalúan retorno · Shell Loran · retraso modelos contratos"]],
      ["green","up","FMI · COP+XOM retorno · Shell Loran · retrasos contratos"],
      ["green","up","FMI+BM reanudan · GL-56/57 · Grupo Cisneros USD 1.000M · ENI+Repsol retoman · Chevron 49% Petroindependencia"],
  ...
  { dim:"Económico", icon:"📊", esc:"E2", name:"Sistema eléctrico nacional", desc:"Rehabilitación como precondición para reactivación",
    ...
    hist:[
      ["yellow","up","Siemens/GE evalúan Bajo Caroní · CAF reactiva"],
      ["yellow","up","CAF reactiva plan 7 años"],
      ["yellow","flat","Sin datos nuevos"],
      ["yellow","flat","Sin datos nuevos · boletín epidemiológico publicado (1° en más de una década) · crisis sanitaria emergente"],
      ["yellow","flat","Siemens y GE en conversaciones Zulia · sin acuerdo firmado · CAF activa"],
  ...
  { dim:"Político", icon:"🏛", esc:"E1", name:"Continuidad constitucional del interinato", desc:"Reloj jurídico del mandato encargado: plazos, prórroga AN, definición falta temporal vs. absoluta",
    ...
    hist:[
      ["yellow","up","90 días cumplidos · debate abierto · prórroga AN escenario base"],
      ["yellow","flat","90 días cumplidos · prórroga AN antes julio · debate falta temporal vs absoluta"],
      ["yellow","flat","Debate 180 días activo · prórroga AN escenario base · rumores jubilación 12 magistrados TSJ"],
