...
export const SITREP_ALL = [
  ...
  { period:"10 – 17 de abril de 2026", periodShort:"10–17 abr 2026",
    ...
    actores:[
      { name:"EE.UU.", items:["Kozak (Depto. Estado): Fase 1 'básicamente cumplida' · Fase 2 = recuperación + reconciliación + condiciones electorales","Haustveit (Energía): visita Caracas · firma acuerdos Chevron–PDVSA · primera vez Depto. Energía en Venezuela","GL-56 y GL-57 (OFAC): apertura financiera condicionada · GL-57 habilita BCV y banca pública","Rubio: Venezuela como instrumento geopolítico · no permitirá control sector por China/Rusia/Irán","Chris Wright: elecciones no son prioridad inmediata · podrían ocurrir 'durante la administración' Trump","Bessent (Tesoro): respalda reincorporación Venezuela al FMI · objetivo 'economía normal'","Relevo diplomático: Dogu concluye · John Barrett (ex-Guatemala) asume como nuevo encargado"] },
      { name:"Gobierno Interino (Rodríguez)", items:["Reunión con Haustveit en Miraflores · reitera necesidad de levantamiento total de sanciones","Registro FARA: Smaili registrado como agente extranjero para cabildeo Depto. Estado + Casa Blanca + campaña política 2027","Promulgación Ley Orgánica de Minas · apertura a inversión privada y extranjera · agradece explícitamente a Trump","Ratificación Obregón en PDVSA (Decreto N.° 5.273) · cambios en planificación, exploración, refinación y finanzas","Designación Luis Pérez como nuevo presidente del BCV · sustituye a Laura Guerra","Liberación 51 detenidos caso PDVSA Obrero en Yare sin comunicación oficial clara","Celebración reanudación FMI/BM · recepción delegación UE (Pelayo Castro) · Monómeros: no se vende"] },
      { name:"Asamblea Nacional", items:["Jorge Rodríguez descarta calificar momento como 'transición' · prefiere 'nuevo momento político'","Prioriza recuperación económica sobre calendario electoral · defiende relación con EE.UU. como 'cooperación'","Rumores jubilación 12 magistrados TSJ (Villegas) · sin confirmación oficial","Diosdado Cabello: elecciones 'serán cuando sean' · resta urgencia a demandas electorales"] },
      { name:"Oposición / Sociedad Civil", items:["PUD presenta hoja de ruta con 8 condiciones: presos políticos, cese persecución, reinstitucionalización, apertura cívica, CNE independiente, garantías electorales, retorno exiliados","PUD articula agenda con Fedecámaras + gremios periodísticos (CNP, SNTP) · base de consenso ampliada","MCM recibida por Macron en Elíseo (13 abr) + reunión PM Países Bajos La Haya (15 abr) · gira respaldo internacional","MCM: retorno inminente 'decisión definitiva' · requieren técnicamente ≥40 semanas para elecciones libres","Vente Venezuela: jornadas organizativas Mérida, Anzoátegui, Carabobo, Zulia (11–12 abr) · exige falta absoluta y elecciones en 30 días","Freddy Superlano liberado (~18 meses) · presos políticos como eje innegociable de transición","Detención-liberación Alexis Paparoni (DGCIM Maiquetía) · bajo régimen de presentación","Sindicatos marchan hacia embajada EE.UU. (16 abr) exigiendo elecciones, salarios y libertad de presos"] },
      { name:"Comunidad Internacional", items:["FMI reanuda relaciones (16 abr): primer movimiento institucional en más de dos décadas · potencial DEG ~USD 5.000M","Banco Mundial reanuda relaciones simultáneamente: último préstamo en 2005 · asistencia técnica + evaluaciones","Macron recibe a MCM en el Elíseo (13 abr): respaldo político de Francia a la causa democrática venezolana","ENI retoma exportaciones: ~1M bbl crudo pesado desde José (Anzoátegui) hacia Cartagena (España) · primera en casi 2 años","Repsol: objetivo triplicar producción en 3 años · actualmente ~45.000 b/d · meta control operativo Petroquiriquire","Caso Maduro-Flores NY: juez Hellerstein rechaza compartir material probatorio con coacusados prófugos","España cierra vía exprés para venezolanos desde junio 2026 · elimina mecanismo vigente desde 2018 (~240.000 beneficiados)"] },
    ],
    nacional: {
      amnistia: { solicitudes:null, libertades:null, excarcelados:null, cautelares:null, militares:null, fpVerificados:690, fpDetenidos:400, fpNota:"Más de 400 presos políticos persisten según reportes (análisis 100 días). Liberación de 51 detenidos del caso PDVSA Obrero en Yare ejecutada sin comunicación oficial clara — medida presentada como 'orden presidencial'. Detención-liberación de Alexis Paparoni (DGCIM Maiquetía) bajo régimen de presentación. Freddy Superlano liberado tras ~18 meses." },
      rodriguez: [
        { title:"Reconfiguración institucional financiera y energética", text:"Luis Pérez designado nuevo presidente del BCV (sustituyendo a Laura Guerra) en el momento de mayor exposición internacional post-GL-57 y reanudación FMI/BM. Héctor Obregón ratificado en PDVSA con cambios en planificación, exploración, refinación y finanzas (Decreto N.° 5.273). Ley Orgánica de Minas promulgada con apertura a inversión privada y extranjera." },
        { title:"Registro FARA: candidatura 2027 avanza en paralelo a la gestión", text:"Jihad M. Smaili se registró como agente extranjero de Rodríguez ante el Departamento de Estado y la Casa Blanca, incluyendo apoyo a su 'campaña política' y gestión de activos de PDVSA/CITGO. Confirma que la preparación para 2027 opera como proyecto paralelo a la conducción del ejecutivo." },
        { title:"Padrino López regresa al gabinete y relevo diplomático EE.UU.", text:"El general Padrino López —sancionado por EE.UU. con recompensa de USD 15 millones por presuntos cargos de narcotráfico— fue designado ministro de Agricultura Productiva, generando interrogantes sobre acuerdos implícitos con Washington. Laura Dogu concluyó su misión; John Barrett asumirá como nuevo encargado de negocios." },
        { title:"Apertura multilateral celebrada y diversificación de interlocutores", text:"Rodríguez celebró la reanudación de relaciones con FMI y BM. Recibió delegación de la UE (Pelayo Castro). Descartó la venta de Monómeros por su valor estratégico en fertilizantes. Agradeció explícitamente a Trump durante la promulgación de la Ley de Minas." },
      ],
    },
    economia: {
      kpis: [
        { value:"13,1%", label:"Inflación mensual (BCV, marzo) — acumulado 2026: 71,8%", color:"#E5243B" },
        { value:"649,5%", label:"Inflación anualizada (BCV)", color:"#dc2626" },
        { value:"USD 3.336M", label:"Superávit cuenta corriente 2025 (BCV publica balanza pagos)", color:"#16a34a" },
        { value:"~USD 5.000M", label:"DEG potenciales FMI (acceso estimado)", color:"#0468B1" },
        { value:"570,75", label:"Tasa oficial BCV (Bs/USD) — brecha ~30% con paralelo", color:"#ca8a04" },
      ],
      empresas: [
        { empresa:"Chevron–PDVSA", desarrollo:"Intercambio de activos en Faja del Orinoco: Chevron eleva participación en Petroindependencia al 49% e incorpora bloque Ayacucho 8, cediendo activos gasíferos offshore (Plataforma Deltana). EE.UU. reporta 150 millones de barriles comercializados desde enero. Suelopetrol cuestiona expansión por falta de notificación formal." },
        { empresa:"Shell", desarrollo:"Se perfila como operador del yacimiento transfronterizo Loran-Manatee (Venezuela–Trinidad y Tobago), con ~7,3 billones de pies cúbicos de reservas en el lado venezolano. Primer gas confirmado para mediados de 2027." },
        { empresa:"ENI", desarrollo:"Retoma exportaciones: ~1 millón de barriles de crudo pesado desde la terminal de José (Anzoátegui) hacia Cartagena (España). Primera operación en casi dos años. Apertura del mercado europeo." },
        { empresa:"Repsol", desarrollo:"Anuncia objetivo de triplicar producción en tres años: actualmente ~45.000 b/d, con meta de asumir control operativo de Petroquiriquire. Crecimiento >50% en el corto plazo." },
        { empresa:"FMI + Banco Mundial", desarrollo:"Reanudación simultánea de relaciones (16 abr). FMI: revisión Artículo IV + potencial acceso DEG ~USD 5.000M. BM: habilita evaluaciones económicas, asistencia técnica y programas de apoyo. Debate central: ¿recursos a repago de deuda multilateral (BID, CAF) o gasto directo?" },
      ],
    },
    opinionPublica: {
      protestas: {
    ...
    marcoNormativo: {
      ...
      cambios: [
        { titulo:"E1 — Prórroga formal: escenario base", texto:"AN autoriza extensión de 90 días adicionales; mandato hasta julio 2026. Preserva estabilidad institucional y da margen para reformas y preparación electoral. Salida más funcional para todos los actores. Probabilidad: ALTA.", color:"#0468B1" },
        { titulo:"E2 — Falta absoluta: elecciones en 30 días", texto:"TSJ o AN declaran ausencia definitiva; Art. 233 activa elecciones en 30 días. Políticamente improbable sin consenso sobre reglas electorales y CNE. Probabilidad: BAJA.", color:"#16a34a" },
        { titulo:"E3 — Extensión indefinida: ambigüedad jurídica", texto:"TSJ mantiene ambigüedad jurídica más allá de los 180 días constitucionales. Erosiona legitimidad; genera presiones internas e internacionales crecientes. Probabilidad: MEDIA.", color:"#ca8a04" },
        { titulo:"Rumores jubilación 12 magistrados TSJ", texto:"De confirmarse, implicaría reconfiguración del máximo tribunal en un momento constitucional crítico. Sin confirmación oficial a la fecha de corte.", color:"#E5243B" },
      ],
  ...
  { period:"17 – 24 de abril de 2026", periodShort:"17–24 abr 2026",
    ...
    actores:[
      { name:"EE.UU.", items:["John Barrett llega como encargado de negocios (23 abr) — Fase 2 centrada en resultados concretos para ciudadanos de ambos países","Kozak-Figuera: respaldo a la AN de 2015 como referente institucional · transición estable, ordenada y sostenida","~USD 3.000M en fondo bajo administración EE.UU. · KPMG elaborará informes trimestrales de auditoría","Reportes: Rubio coordina renovación autoridades BCV · Deloitte audita finanzas internacionales del instituto emisor","Tesoro valora reintegración al FMI como estrategia de combinar presión política con apertura económica"] },
      { name:"Gobierno Interino (Rodríguez)", items:["Balance 100 días (19 abr): amnistía 8.616, PDVSA 1,1M bpd, relaciones FMI-BM, 3 homicidios/100K, 5.000 migrantes retornados","Gran Peregrinación Nacional 19 abr – 1° mayo: instrumento de legitimación interna lanzado desde 3 estados en simultáneo","Comisión Clasificación Activos Públicos: 4 categorías (estratégicos, PPP, oferta, liquidación) · Pisella sector privado","Ley Orgánica de Minas G.O. 7.020: 3 entes, concesiones 50 años, derogación Ley del Oro 2015, apertura extranjera","Conversaciones con Siemens y GE para rehabilitar sistema eléctrico del Zulia · Destitución >12.000 policías por corrupción","Comisión Reforma Penal instalada · fase cierre amnistía anunciada · Carlos Alvarado designado ministro Salud","Zona Rental UCV devuelta a la universidad · BCV designa vicepresidente gerente suplente Pascual Pinto Lentino"] },
      { name:"Asamblea Nacional", items:["Comisión Preliminar del TSJ designada: Alessandrello preside · composición mixta con presencia opositora","Ley Orgánica de Minas publicada en G.O. Ext. 7.020 del 16 de abril","Arreaza: 12.187 solicitudes válidas · 8.616 libertades otorgadas (314 privados + 8.302 cautelares)","Sesión 21 abr: Comité Postulaciones Judiciales + acuerdo respaldo Peregrinación + conmemoración 19 Abril","Caso PDVSA-Cripto avanza a juicio: El Aissami, Roa y Samark López · más de 60 procesados"] },
      { name:"Oposición / Sociedad Civil", items:["MCM: «hoy comienza el regreso a casa» — Puerta del Sol abarrotada · medalla Madrid · PM Portugal Montenegro","Propuesta acuerdo nacional con rutas simultáneas: liberación presos y retorno migrantes como condiciones mínimas","Reunión Figuera-Kozak: PUD agradece respaldo AN-2015 · hoja de ruta alineada con transición sostenida","Reconfiguración interna: Darwin González se une a PUD · Fuerza Vecinal + Vamos Cojedes + MIN Unidad → Alianza Nacional de Centro","Detención Alexis Paparoni (DGCIM Maiquetía): PJ detenido al viajar · liberado bajo presentación mensual · MCM: señal disuasiva","Machado: retrasar elecciones es más riesgoso que acelerarlas · 40 semanas técnicas para organizar comicios libres","Capriles exige debate salarial real · 473 presos políticos (Foro Penal) + 672 (JEP) · 49 enfermos graves + 22 adultos mayores"] },
      { name:"Comunidad Internacional", items:["Petro viaja a Caracas (24 abr): cogobernanza 1-2 años · seguridad fronteriza · narcotráfico · tensión con MCM","FMI: Georgieva advierte «camino muy difícil» · inflación 3 dígitos · economía contraída 2/3 · vicepresidente: no es plan de financiamiento","Banco Mundial celebra apertura · BID se prepara para reanudar operaciones · PNUD proyecta crecimiento 7,4% para 2026","Chile busca restablecer relaciones consulares motivado por gestión migratoria venezolana en su territorio","Mercosur evalúa retorno de Venezuela · Brasil impulsa revisar suspensión · Sánchez ofrece reunión con MCM","Eni-Repsol planean GNL 2031 (Perla 17 TCF) · Halliburton evalúa retorno · Alvorada Brasil amplía Faja del Orinoco"] },
    ],
    nacional:{
      amnistia:{
        solicitudes:12187,
      ...
      rodriguez:[
        ...
        { title:"Reconfiguración institucional: Ley de Minas, Activos Públicos y Poder Judicial", text:"Ley Orgánica de Minas G.O. 7.020 (16 abr): crea Superintendencia Nacional Minera, Banco Nacional del Dato Geocientífico-Minero y Fondo Nacional Minero; deroga Ley del Oro de 2015, concesiones hasta 50 años, arbitraje ampliado — Gold Reserve celebra norma como alineada con Licencia GL-55. Comisión Clasificación Activos Públicos instalada con cuatro categorías. Comisión Preliminar del TSJ designada." },
        { title:"Balance 100 días y agenda social", text:"Rodríguez presentó balance de 100 días: 8.616 libertades por amnistía, 3 homicidios por 100.000 hab., PDVSA 1,1M bpd, retorno 5.000 migrantes. Carlos Alvarado designado nuevo ministro de Salud (médico UCV, expresidente IVSS). Zona Rental Plaza Venezuela devuelta a la UCV. Cabello anunció destitución de más de 12.000 policías por corrupción y extorsión en alcabalas." },
        { title:"Energético: Siemens, GE y rehabilitación del Zulia", text:"Rodríguez anunció conversaciones directas con Siemens y GE para rehabilitar el sistema eléctrico del Zulia, como parte del marco de cooperación con empresas estadounidenses y europeas. Halliburton evalúa retorno: infraestructura en mejores condiciones de lo esperado. Eni-Repsol planean iniciar exportaciones GNL desde Venezuela hacia finales de 2031 (Perla/Cardón IV: hasta 17 TCF)." },
      ],
    },
    economia:{
      kpis:[
        { value:"1,1M bpd", label:"Producción PDVSA · meta 1,37M bpd dic 2026", color:"#16a34a" },
        { value:"~USD 5.137M", label:"DEG potenciales FMI · acceso sujeto a acuerdos técnicos", color:"#0468B1" },
        { value:"~650%", label:"Inflación anualizada · FMI: «camino muy difícil»", color:"#dc2626" },
        { value:"7,4%", label:"Crecimiento proy. 2026 (PNUD) · desde base 35,7% nivel 2012", color:"#ca8a04" },
        { value:">USD 21.000M", label:"Brecha salarial anual: costo canasta básica empleados+pensionados", color:"#dc2626" },
      ],
      empresas:[
        { empresa:"FMI + BM + BID", desarrollo:"3 organismos multilaterales reanudan vínculos simultáneamente. FMI: agenda técnica 3 ejes (datos, política pública, institucionalidad) · DEG ~USD 5.137M como reserva monetaria, no gasto corriente · Georgieva advierte «camino muy difícil». BM: fase preparatoria de asistencia técnica. BID: se prepara para reanudar operaciones." },
        { empresa:"Halliburton", desarrollo:"Evalúa retorno a Venezuela con evaluación de infraestructura (en mejores condiciones de lo esperado) y exploración de contratación de personal. Reentrada efectiva depende de condiciones contractuales y regulatorias en negociación. Analistas estiman recuperación del aparato petrolero requeriría hasta USD 10.000M anuales de inversión sostenida." },
        { empresa:"Eni + Repsol", desarrollo:"Planean iniciar exportaciones de GNL desde Venezuela hacia finales de 2031, tras acuerdo para reactivar el proyecto offshore Perla/Cardón IV. Reservas estimadas del campo Perla: hasta 17 TCF. Apuesta estructural de largo plazo condicionada a inversión sostenida y estabilidad regulatoria." },
        { empresa:"Alvorada Heavy Industries (Brasil)", desarrollo:"Empresa brasileña respaldada por Galapagos Capital incrementa producción en tres bloques de la Faja del Orinoco y evalúa nuevas adquisiciones y servicios, reflejando creciente apetito regional por participar en la reapertura petrolera." },
        { empresa:"Siemens + GE", desarrollo:"Gobierno mantiene conversaciones directas con ambas empresas para rehabilitar el sistema eléctrico del Zulia. Marco de cooperación internacional con empresas estadounidenses y europeas en energía como señal positiva — sin acuerdo firmado a la fecha de corte." },
        { empresa:"Comisión Activos Públicos", desarrollo:"Rodríguez instala comisión con cuatro categorías: (1) bienes estratégicos Estado; (2) alianzas PPP; (3) oferta para activos no estratégicos; (4) liquidación y aprovechamiento. Inclusión de Luigi Pisella (expresidente Conindustria) señala apertura al capital empresarial en gestión de activos estatales." },
      ],
    },
    opinionPublica:{
      protestas:{
      ...
      percepcion:{
        ...
        datos:[
          { factor:"Protestas en 1 día — paro universitario (22 abr)", pct:27 },
          { factor:"Estados en pico simultáneo (22 abr)", pct:18 },
          { factor:"ONG: presos políticos fuera del alcance de la amnistía", pct:70 },
        ],
      },
      excarcelados:{ fp:690, presos:473, militares:187, fuente:"Foro Penal 20-abr · JEP: 672 casos · amnistía <30% beneficiados (ONG)" },
    },
    marcoNormativo:{
      ...
      cambios:[
        { titulo:"Ley Orgánica de Minas — cambios clave", texto:"Crea: Superintendencia Nacional de la Actividad Minera, Banco Nacional del Dato Geocientífico-Minero, Fondo Nacional Minero. Deroga: Ley del Oro de 2015 (participación mayoritaria obligatoria del Estado). Concesiones: hasta 30 años + 2 prórrogas de 10 años = máximo 50 años. Regalías determinadas contractualmente. Arbitraje ampliado. BCV mantiene derecho preferente sobre el oro.", color:"#16a34a" },
        { titulo:"Comisión Preliminar del TSJ", texto:"AN designa comisión presidida por Alessandrello con presencia de distintos sectores políticos. La credibilidad del resultado depende de la independencia real del proceso. Composición incluye representantes de oposición.", color:"#0468B1" },
        { titulo:"Debate constitucional: 180 días del interinato", texto:"AN debe aprobar prórroga formal antes de julio 2026 — primer test institucional del interinato. Cabello descarta explícitamente elecciones en el corto y mediano plazo. Reportes no confirmados: desde Washington se comunicaría que no se contemplan elecciones próximas.", color:"#ca8a04" },
        { titulo:"Comisión de Clasificación de Activos Públicos", texto:"Cuatro categorías: (1) bienes estratégicos Estado; (2) alianzas PPP; (3) oferta; (4) liquidación. Integrada por Seijo (procuradora), ministros de Economía-Comercio-Comunas y Luigi Pisella por el sector privado. Apertura selectiva al capital empresarial.", color:"#8b5cf6" },
      ],
      comparativaHeaders:["Ley del Oro 2015","Ley de Minas 2026"],
      comparativa:[
        { dim:"Participación del Estado", antes:"Mayoría obligatoria en proyectos auríferos", despues:"Eliminada — capital privado y extranjero sin restricción de porcentaje" },
        { dim:"Duración concesiones", antes:"Sin plazo máximo claro", despues:"Hasta 50 años (30 + dos prórrogas de 10)" },
        { dim:"Resolución de disputas", antes:"Marco limitado", despues:"Arbitraje ampliado" },
        { dim:"Nuevos entes creados", antes:"0", despues:"3 (Superintendencia, Banco del Dato, Fondo Minero)" },
        { dim:"Regalías", antes:"Fijas", despues:"Determinadas contractualmente dentro de límites legales" },
        { dim:"Minería ilegal", antes:"Régimen sancionatorio existente", despues:"Endurecido" },
      ],
    ...
    escenarios:[
      { name:"Continuidad Negociada (E3)", prob:"46%", color:"#0468B1", text:"Cede 1pp sin perder posición dominante. La semana consolida la arquitectura del interinato: Barrett llega, 3 multilaterales simultáneos, Ley de Minas, Comisión Activos, Comisión TSJ. La propuesta de cogobernanza de Petro —1-2 años— y el descarte explícito de Cabello de un cronograma electoral refuerzan la lógica de transición gestionada y prolongada. La negociación BCV-Deloitte coordinada por Rubio, de confirmarse, sería un acuerdo entre élites bajo supervisión exterior, no una transición democrática inmediata." },
      { name:"Transición Política Pacífica (E1)", prob:"38%", color:"#2d8a30", text:"Sube 3pp — brecha más estrecha con E3 desde el inicio del proceso. Impulsado por: anuncio de retorno de MCM desde Puerta del Sol, reunión con PM de Portugal, propuesta de acuerdo nacional con rutas simultáneas, coordinación PUD-EE.UU. vía Figuera-Kozak. E1 encuentra su límite en la ausencia de movimientos concretos en el CNE y en la posición de Cabello. El retorno efectivo de MCM sin represalia es el próximo test del escenario." },
      { name:"Resistencia Coercitiva (E4)", prob:"12%", color:"#ca8a04", text:"Baja 1pp por ausencia de escalada coercitiva sistémica: detención Paparoni fue selectiva sin continuación, motín Yare III no generó represión externa, freno bilateral activo. Con todo, el patrón de control selectivo —Paparoni, amnistía <30%, 473 presos— confirma que el vector coercitivo opera de forma contenida. El 1° de mayo y el retorno de MCM son los dos test inmediatos." },
      { name:"Colapso y Fragmentación (E2)", prob:"4%", color:"#dc2626", text:"Cede 1pp por solidez del entramado multilateral recién ampliado. Fragilidades estructurales intactas: inflación ~650%, brecha salarial >USD 21.000M anual, vacío constitucional 180 días, motín Yare III. La advertencia de Georgieva —«camino muy difícil»— es el reconocimiento más explícito de fragilidad del período y contrasta con las expectativas declaradas por el gobierno sobre el uso de los DEG." },
    ],
    comentarios:[
      { tag:"Factor 1", color:"#16a34a", title:"FMI + BM + BID simultáneos: la acumulación multilateral más significativa del período", text:"La reanudación simultánea de vínculos con los tres principales organismos multilaterales representa el avance institucional más significativo del período. Sin embargo, la advertencia de Georgieva —«el camino será muy difícil»— y la aclaración del vicepresidente económico de que el proceso no responde a ningún plan de financiamiento ubican el momento en una etapa preparatoria y técnica, no en un programa de apoyo inmediato. Los DEG son liquidez de reserva, no presupuesto ejecutable. La distancia entre las expectativas declaradas por el gobierno y los plazos reales del proceso multilateral es el principal riesgo de sobreprometer." },
      { tag:"Factor 2", color:"#0468B1", title:"Barrett + negociación BCV: Fase 2 como arquitectura negociada de estabilización", text:"La llegada de Barrett como encargado de negocios y los reportes sobre la negociación coordinada por Rubio para renovar las autoridades del BCV con auditoría de Deloitte configuran, de confirmarse, un esquema de acuerdo entre élites bajo supervisión bilateral. EE.UU. mantiene el control sobre los flujos financieros venezolanos (~USD 3.000M bajo administración + KPMG) mientras avanza en la normalización. El mensaje de Barrett —centrado en resultados concretos para ciudadanos de ambos países— no incluye condiciones electorales explícitas." },
      { tag:"Factor 3", color:"#ca8a04", title:"El retorno de MCM: el evento político de mayor impacto anticipado del proceso", text:"La gira europea de Machado —medalla de Madrid, discurso Puerta del Sol, reunión con PM Portugal— consolidó su visibilidad internacional y precipitó el anuncio de retorno. Con el 68,9% de intención de voto y el 53% de imagen positiva (encuestas previas), su regreso tendrá impacto inmediato sobre la dinámica política: activará la base opositora, pondrá a prueba las garantías del gobierno interino y determinará si EE.UU. presiona por condiciones de seguridad efectivas. La detención de Paparoni por la DGCIM es la primera señal del ambiente que la espera." },
      { tag:"Factor 4", color:"#E5243B", title:"1° de mayo: convergencia Gran Peregrinación y movilización laboral — test estructural", text:"Las 46 protestas de la semana —con pico de 27 el 22 de abril (paro universitario, 18 estados)— confirman que el ciclo de conflictividad permanece abierto. El salario mínimo permanece por debajo de un dólar desde hace cuatro años, y cualquier aumento sin montos precisos ni mecanismos de indexación será absorbido por una inflación anualizada de ~650%. La convocatoria de la Gran Peregrinación oficialista hacia ese mismo día genera una superposición de agendas que puede producir tanto un acto de unidad como una colisión en el espacio público. El motín de Yare III y los 473 presos políticos amplían el espectro de la conflictividad más allá del sector laboral." },
    ],
  },
...
export const CURATED_FACTCHECK = [
  ...
  { title:"FMI y Banco Mundial reanudan relaciones con Venezuela simultáneamente (16 abr) — primera vez en más de dos décadas", date:"2026-04-16", source:"FMI/BM", scenarios:["E3","E1"], dims:["Internacional","Económico"], week:"S14" },
  { title:"Acceso potencial a DEG estimados en ~USD 5.000M; debate sobre destino: repago deuda multilateral (BID, CAF) vs. gasto directo", date:"2026-04-16", source:"FMI/Bloomberg", scenarios:["E3"], dims:["Internacional","Económico"], week:"S14" },
  { title:"Bessent (Tesoro EE.UU.) respalda reincorporación Venezuela al FMI — objetivo que país opere como 'economía normal'", date:"2026-04-16", source:"Tesoro EE.UU.", scenarios:["E3"], dims:["Internacional","Económico"], week:"S14" },
  { title:"ENI retoma exportaciones: ~1M barriles crudo pesado desde José (Anzoátegui) hacia Cartagena (España) — primera operación en casi 2 años", date:"2026-04-14", source:"ENI/Reuters", scenarios:["E3"], dims:["Internacional","Energético"], week:"S14" },
  { title:"Repsol anuncia objetivo de triplicar producción en 3 años: ~45.000 b/d actuales; meta control operativo Petroquiriquire", date:"2026-04-15", source:"Repsol", scenarios:["E3"], dims:["Internacional","Energético"], week:"S14" },
  { title:"España cierra vía exprés para venezolanos desde junio 2026 — afecta mecanismo vigente desde 2018 (~240.000 beneficiados)", date:"2026-04-12", source:"Gobierno España", scenarios:["E2"], dims:["Internacional","Social"], week:"S14" },
  { title:"Macron recibe a MCM en el Elíseo (13 abr) — respaldo político de Francia a causa democrática venezolana", date:"2026-04-13", source:"Élysée/MCM", scenarios:["E1"], dims:["Internacional","Político"], week:"S14" },
  // ── Energético ──
  { title:"OFAC emite GL-56: habilita negociaciones comerciales condicionadas (MoU, licitaciones, contratos) — prohibición pagos en oro/criptoactivos", date:"2026-04-11", source:"OFAC", scenarios:["E3"], dims:["Energético","Económico","Internacional"], week:"S14" },
  { title:"OFAC emite GL-57: flexibiliza operaciones con BCV y banca pública venezolana — sin levantar activos congelados ni normalización plena", date:"2026-04-11", source:"OFAC", scenarios:["E3"], dims:["Energético","Económico","Internacional"], week:"S14" },
  { title:"Haustveit (Depto. Energía EE.UU.) visita Caracas — primera visita oficial del Departamento de Energía en el marco bilateral", date:"2026-04-14", source:"Depto. Energía EE.UU.", scenarios:["E3"], dims:["Energético","Internacional"], week:"S14" },
  { title:"Chevron–PDVSA: Chevron eleva participación en Petroindependencia al 49% e incorpora bloque Ayacucho 8; cede Plataforma Deltana", date:"2026-04-14", source:"Chevron/PDVSA", scenarios:["E3"], dims:["Energético"], week:"S14" },
  { title:"EE.UU. reporta 150 millones de barriles venezolanos comercializados desde enero 2026 — producción creció de ~950 kb/d a >1,2 Mb/d", date:"2026-04-14", source:"Depto. Energía EE.UU.", scenarios:["E3"], dims:["Energético","Internacional"], week:"S14" },
  { title:"Suelopetrol cuestiona expansión Chevron en Petroindependencia al 49% — afirma no haber sido notificada; interrogantes sobre gobernanza", date:"2026-04-15", source:"Suelopetrol/Prensa", scenarios:["E2","E3"], dims:["Energético"], week:"S14" },
  { title:"Shell asume operación campo Loran-Manatee (VEN–T&T): ~7,3 TCF en lado venezolano; complementa Petrocaribe II y 2,7 TCF en Trinidad", date:"2026-04-15", source:"Reuters", scenarios:["E3"], dims:["Energético","Internacional"], week:"S14" },
  { title:"OPEP abril 2026: Merey USD 85,92/b en marzo (+33,61 USD intermensual); producción sec. 988 kb/d; cifras oficiales 1,095 Mb/d (+75 kb/d)", date:"2026-04-10", source:"OPEP/MPPPH", scenarios:["E3"], dims:["Energético"], week:"S14" },
  // ── Político ──
  { title:"Kozak (Depto. Estado) declara ante Congreso Fase 1 'básicamente cumplida' — Fase 2: recuperación económica + reconciliación política", date:"2026-04-15", source:"Depto. Estado EE.UU.", scenarios:["E3","E1"], dims:["Político","Internacional"], week:"S14" },
  { title:"EE.UU. fija condiciones Fase 2: renovación CNE, auditorías KPMG y retorno libre de MCM al país", date:"2026-04-15", source:"Depto. Estado EE.UU.", scenarios:["E1","E3"], dims:["Político","Internacional"], week:"S14" },
  { title:"Chris Wright: elecciones en Venezuela 'no son prioridad inmediata' — podrían ocurrir 'durante la administración' Trump", date:"2026-04-12", source:"Depto. Energía EE.UU.", scenarios:["E3"], dims:["Político","Internacional"], week:"S14" },
  { title:"Rubio: Venezuela como instrumento de influencia geopolítica — EE.UU. no permitirá control del sector por China, Rusia o Irán", date:"2026-04-13", source:"Rubio/Estado", scenarios:["E3","E4"], dims:["Político","Internacional","Energético"], week:"S14" },
  { title:"PUD presenta hoja de ruta con 8 condiciones para la transición — articulada con Fedecámaras, CNP y SNTP", date:"2026-04-12", source:"PUD", scenarios:["E1"], dims:["Político"], week:"S14" },
  { title:"MCM: retorno al país como 'decisión definitiva' — requieren técnicamente ≥40 semanas para organizar elecciones libres", date:"2026-04-13", source:"MCM", scenarios:["E1"], dims:["Político","Internacional"], week:"S14" },
  { title:"Registro FARA: Smaili como agente extranjero de Rodríguez para cabildeo Depto. Estado + Casa Blanca + 'campaña política' 2027", date:"2026-04-11", source:"Depto. Justicia EE.UU./FARA", scenarios:["E3","E1"], dims:["Político","Internacional"], week:"S14" },
  { title:"Padrino López (sancionado EE.UU. · recompensa USD 15M) designado ministro de Agricultura — interrogantes sobre acuerdos implícitos", date:"2026-04-10", source:"Gobierno VEN", scenarios:["E3","E4"], dims:["Político"], week:"S14" },
  { title:"Ley Orgánica de Minas promulgada — apertura del sector a inversión privada y extranjera; Rodríguez agradece a Trump", date:"2026-04-10", source:"Gobierno VEN/AN", scenarios:["E3"], dims:["Político","Energético"], week:"S14" },
  { title:"Designación Luis Pérez como nuevo presidente del BCV en sustitución de Laura Guerra — Ratificación Obregón en PDVSA (Decreto N.° 5.273)", date:"2026-04-11", source:"Gobierno VEN", scenarios:["E3"], dims:["Político","Económico"], week:"S14" },
  { title:"Jorge Rodríguez (AN) descarta calificar momento como 'transición'; Cabello: elecciones 'serán cuando sean'", date:"2026-04-12", source:"AN/VTV", scenarios:["E3","E4"], dims:["Político","Constitucional"], week:"S14" },
  { title:"Rumores jubilación 12 magistrados del TSJ (Villegas) — sin confirmación oficial; implicaría reconfiguración en momento constitucional crítico", date:"2026-04-14", source:"Vladimir Villegas/Prensa", scenarios:["E3","E2"], dims:["Político","Constitucional"], week:"S14" },
  { title:"Liberación 51 detenidos caso PDVSA Obrero en Yare — ejecutada sin comunicación oficial clara, como 'orden presidencial'", date:"2026-04-11", source:"Prensa/PUD", scenarios:["E3","E1"], dims:["Político"], week:"S14" },
  // ── Social ──
  { title:"47 protestas OVCS (10–16 abr) en 15 estados — promedio 9,4 diario; desaceleración respecto al pico 9-abr (72) pero tensión sostenida", date:"2026-04-16", source:"OVCS", scenarios:["E4","E1"], dims:["Social"], week:"S14" },
  { title:"Politización creciente de exigencias: laborales + derechos políticos + presos políticos + servicios públicos — evolución estructural", date:"2026-04-16", source:"OVCS/Análisis", scenarios:["E4","E1"], dims:["Social","Político"], week:"S14" },
  { title:"Movilización sindical hacia embajada EE.UU. (16 abr): primer caso de presión dirigida a actor internacional como canal de demanda política", date:"2026-04-16", source:"Sindicatos/OVCS", scenarios:["E1","E4"], dims:["Social","Internacional","Político"], week:"S14" },
  { title:"Detención-liberación Alexis Paparoni (DGCIM Maiquetía) — liberado bajo régimen de presentación; caso genera preocupaciones sobre control judicial", date:"2026-04-12", source:"PUD/Prensa", scenarios:["E4"], dims:["Social","Político"], week:"S14" },
  { title:"Crisis sanitaria: epidemia activa fiebre amarilla (letalidad 55,3%, 14 estados) + más de 25.000 casos malaria acumulados en 2026", date:"2026-04-15", source:"Ministerio Salud/Boletín Epidemiológico", scenarios:["E2","E4"], dims:["Social"], week:"S14" },
  // ── Económico ──
  { title:"BCV publica balanza de pagos 2025 (tras años de opacidad): superávit cuenta corriente USD 3.336M (+USD 982M vs. 2024) — sector petrolero como motor", date:"2026-04-14", source:"BCV", scenarios:["E3"], dims:["Económico"], week:"S14" },
  { title:"Bonos venezolanos 2027 se acercan a 48 centavos por dólar; PDVSA también al alza ante expectativas de normalización", date:"2026-04-15", source:"Bloomberg/Mercados", scenarios:["E3"], dims:["Económico","Internacional"], week:"S14" },
