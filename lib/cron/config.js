...
// Modelos actualizados 2026-09-05: gemini-1.5-flash, llama-3.3-70b-versatile
// (Groq) y meta-llama/llama-3.1-8b-instruct:free (OpenRouter) fueron retirados
// por sus proveedores (404 model_not_found) — esto dejaba fallar TODA la
// cascada en silencio y es la causa real de que la caché de Alertas de
// Noticias quedara con horas de antigüedad sin refrescarse.
const AI_CASCADE_ALERTS = [
  ...
  { name: "gemini", key: "GEMINI_API_KEY", url: null, model: "gemini-3.6-flash" },
  { name: "groq", key: "GROQ_API_KEY", url: "https://api.groq.com/openai/v1/chat/completions", model: "openai/gpt-oss-120b" },
  { name: "openrouter", key: "OPENROUTER_API_KEY", url: "https://openrouter.ai/api/v1/chat/completions", model: "nvidia/nemotron-3.5-lightning:free" },
];
