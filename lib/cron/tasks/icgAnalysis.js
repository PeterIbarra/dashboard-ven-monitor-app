...
[{"actor":"Delcy Rodríguez","alignment":"ALINEADO","confidence":0.9,"evidence":"razón corta basada en artículos concretos","signals":["señal1","señal2"]},...]`;
    ...
    // Call AI cascade — Groq first (better political reasoning), Mistral as fallback
    // Modelos actualizados 2026-09-05: llama-3.3-70b-versatile (Groq) y
    // meta-llama/llama-3.1-8b-instruct:free (OpenRouter) fueron retirados por
    // sus proveedores (404 model_not_found).
    const AI_CASCADE = [
      { name: "groq", key: "GROQ_API_KEY", url: "https://api.groq.com/openai/v1/chat/completions", model: "openai/gpt-oss-120b", format: "openai" },
      { name: "mistral", key: "MISTRAL_API_KEY", url: "https://api.mistral.ai/v1/chat/completions", model: "mistral-small-latest", format: "openai" },
      { name: "openrouter", key: "OPENROUTER_API_KEY", url: "https://openrouter.ai/api/v1/chat/completions", model: "nvidia/nemotron-3.5-lightning:free", format: "openai" },
    ];
