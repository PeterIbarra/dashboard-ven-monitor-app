...
3. Cada alerta: "nivel" (🔴/🟠/🔵), "titular" (copia exacta del titular original, sin la etiqueta de fuente), "fuente" (nombre del medio), "dimension" (POLÍTICA/PROTESTAS/DDHH/ECONOMÍA/ENERGÍA_Y_RED/SISMOS/INSTITUCIONAL/HUMANITARIO/INTERNACIONAL), "territorio" (estado, municipio, NACIONAL o EXTERIOR) e "impacto" (1 frase de por qué importa para Venezuela).
4. Niveles: 🔴 = ALERTA INMEDIATA: evento confirmado con impacto inmediato o capacidad de mover escenarios. 🟠 = ADVERTENCIA DE ESCALADA: desarrollo relevante que puede intensificarse. 🔵 = EN VIGILANCIA: señal incipiente o contexto que requiere seguimiento.
...
7. Ordena por relevancia: 🔴 primero, luego 🟠, luego 🔵.
8. Formato exacto:
[{"nivel":"🔴","titular":"...","fuente":"...","dimension":"PROTESTAS","territorio":"NACIONAL","impacto":"..."}]`;
