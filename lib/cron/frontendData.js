...
function getFrontendSnapshot() {
  ...
  const snapshot = { scenarios: null, latestWeek: null, kpisLatest: null, latestAmnistia: null, error: null };
  try {
  ...
  try {
    const { WEEKS, KPIS_LATEST } = loadExports("weekly.js", ["WEEKS", "KPIS_LATEST"]);
